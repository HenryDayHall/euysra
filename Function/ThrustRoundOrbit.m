function [ thrust ] = ThrustRoundOrbit( z, sailAngle, numNodes, initialMass, invEffic, e, beta, mu, poleVec, semiAxis, Mp,Ms, k, fSpan)
...
for i=1:(numNodes -1);
    ...
    timeTaken = PeriodFunction(e,Mp,Ms,semiAxis,k,fSpan(i + 1)) - PeriodFunction(e,Mp,Ms,semiAxis,k,fSpan(i));
